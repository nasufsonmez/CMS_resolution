...
void haddPoster_5() {
  ...
  Target = TFile::Open( "Hadd_C_CombinedPileUp_5.root", "RECREATE" );
  ...
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-100-250-PileUp-5.root") );  // 1
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-250-500-PileUp-5.root") );  // 2
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-500-1000-PileUp-5.root") );  // 3
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-1000-2500-PileUp-5.root") ); // 4
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-2500-4000-PileUp-5.root") );// 5
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-4000-6000-PileUp-5.root") );// 6
  FileList->Add( TFile::Open("AnalysisPosterOutputs/AnalysisOutput-6000-Inf-PileUp-5.root") );// 7
