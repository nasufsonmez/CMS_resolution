...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,3),W(1,7),GC_11,AMP(1))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,6),W(1,7),GC_11,AMP(2))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(2,1)=+1D0/2D0*(-AMP(2)-AMP(4)-IMAG1*AMP(5))
