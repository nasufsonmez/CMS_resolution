...
C     
C     Process: g u > u u u~ WEIGHTED<=3 @1
C     Process: g c > c c c~ WEIGHTED<=3 @1
C     Process: g s > s s s~ WEIGHTED<=3 @1
C     Process: g d > d d d~ WEIGHTED<=3 @1
C     Process: g b > b b b~ WEIGHTED<=3 @1
C     Process: g u~ > u u~ u~ WEIGHTED<=3 @1
C     Process: g c~ > c c~ c~ WEIGHTED<=3 @1
C     Process: g s~ > s s~ s~ WEIGHTED<=3 @1
C     Process: g d~ > d d~ d~ WEIGHTED<=3 @1
C     Process: g b~ > b b~ b~ WEIGHTED<=3 @1
C     Process: g u > u c c~ WEIGHTED<=3 @1
C     Process: g u > u s s~ WEIGHTED<=3 @1
C     Process: g u > u d d~ WEIGHTED<=3 @1
C     Process: g u > u b b~ WEIGHTED<=3 @1
C     Process: g c > c u u~ WEIGHTED<=3 @1
C     Process: g c > c s s~ WEIGHTED<=3 @1
C     Process: g c > c d d~ WEIGHTED<=3 @1
C     Process: g c > c b b~ WEIGHTED<=3 @1
C     Process: g s > s u u~ WEIGHTED<=3 @1
C     Process: g s > s c c~ WEIGHTED<=3 @1
C     Process: g s > s d d~ WEIGHTED<=3 @1
C     Process: g s > s b b~ WEIGHTED<=3 @1
C     Process: g d > d u u~ WEIGHTED<=3 @1
C     Process: g d > d c c~ WEIGHTED<=3 @1
C     Process: g d > d s s~ WEIGHTED<=3 @1
C     Process: g d > d b b~ WEIGHTED<=3 @1
C     Process: g b > b u u~ WEIGHTED<=3 @1
C     Process: g b > b c c~ WEIGHTED<=3 @1
C     Process: g b > b s s~ WEIGHTED<=3 @1
C     Process: g b > b d d~ WEIGHTED<=3 @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g u > u u u~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! g u~ > u u~ u~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! g u > u c c~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! g u~ > c u~ c~
      ENDIF
