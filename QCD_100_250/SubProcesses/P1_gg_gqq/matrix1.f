...
C     
C     Process: g g > g u u~ WEIGHTED<=3 @1
C     Process: g g > g c c~ WEIGHTED<=3 @1
C     Process: g g > g s s~ WEIGHTED<=3 @1
C     Process: g g > g d d~ WEIGHTED<=3 @1
C     Process: g g > g b b~ WEIGHTED<=3 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1_1(W(1,4),W(1,3),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,7),W(1,6),GC_11,AMP(1))
      CALL FFV1_2(W(1,5),W(1,3),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,10),W(1,6),GC_11,AMP(4))
      CALL FFV1_2(W(1,5),W(1,2),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,4),W(1,6),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,6),W(1,2),W(1,9),GC_10,AMP(6))
      CALL FFV1_1(W(1,4),W(1,1),GC_11,ZERO,ZERO,W(1,6))
      CALL VVV1P0_1(W(1,2),W(1,3),GC_10,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,6),W(1,12),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,11),W(1,6),W(1,3),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,8),W(1,6),W(1,2),GC_11,AMP(9))
      CALL FFV1_2(W(1,5),W(1,1),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,4),W(1,12),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,6),W(1,10),W(1,3),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,7),W(1,2),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,5),W(1,4),W(1,11),GC_11,AMP(16))
      CALL FFV1_0(W(1,5),W(1,4),W(1,7),GC_11,AMP(17))
      CALL FFV1_0(W(1,5),W(1,4),W(1,10),GC_11,AMP(18))
