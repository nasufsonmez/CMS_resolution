...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,1),W(1,7),GC_11,AMP(1))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,4),W(1,1),GC_11,ZERO,ZERO,W(1,8))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(3,1)=+1D0/2D0*(-AMP(2)-AMP(4)-IMAG1*AMP(5))
      JAMP(4,1)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2))
