...
C     ----------
      ...
      CALL FFV1P0_3(W(1,5),W(1,4),GC_11,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,5),W(1,6),W(1,8),GC_11,AMP(3))
      CALL FFV1_2(W(1,5),W(1,3),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_11,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,3),W(1,8),W(1,7),GC_10,AMP(5))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4))
      JAMP(2,1)=+1D0/2D0*(-AMP(1)-AMP(3)+IMAG1*AMP(5))
      JAMP(3,1)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2))
