...
C     
C     Process: u u > g u u WEIGHTED<=3 @1
C     Process: c c > g c c WEIGHTED<=3 @1
C     Process: s s > g s s WEIGHTED<=3 @1
C     Process: d d > g d d WEIGHTED<=3 @1
C     Process: b b > g b b WEIGHTED<=3 @1
C     Process: u u~ > g u u~ WEIGHTED<=3 @1
C     Process: c c~ > g c c~ WEIGHTED<=3 @1
C     Process: s s~ > g s s~ WEIGHTED<=3 @1
C     Process: d d~ > g d d~ WEIGHTED<=3 @1
...
C     Process: d~ d~ > g d~ d~ WEIGHTED<=3 @1
C     Process: b~ b~ > g b~ b~ WEIGHTED<=3 @1
C     Process: u c > g u c WEIGHTED<=3 @1
C     Process: u s > g u s WEIGHTED<=3 @1
C     Process: u d > g u d WEIGHTED<=3 @1
C     Process: u b > g u b WEIGHTED<=3 @1
C     Process: c s > g c s WEIGHTED<=3 @1
C     Process: c d > g c d WEIGHTED<=3 @1
C     Process: c b > g c b WEIGHTED<=3 @1
C     Process: s d > g s d WEIGHTED<=3 @1
C     Process: s b > g s b WEIGHTED<=3 @1
C     Process: d b > g d b WEIGHTED<=3 @1
C     Process: u u~ > g c c~ WEIGHTED<=3 @1
C     Process: u u~ > g s s~ WEIGHTED<=3 @1
C     Process: u u~ > g d d~ WEIGHTED<=3 @1
C     Process: u u~ > g b b~ WEIGHTED<=3 @1
C     Process: c c~ > g u u~ WEIGHTED<=3 @1
C     Process: c c~ > g s s~ WEIGHTED<=3 @1
C     Process: c c~ > g d d~ WEIGHTED<=3 @1
C     Process: c c~ > g b b~ WEIGHTED<=3 @1
C     Process: s s~ > g u u~ WEIGHTED<=3 @1
C     Process: s s~ > g c c~ WEIGHTED<=3 @1
C     Process: s s~ > g d d~ WEIGHTED<=3 @1
C     Process: s s~ > g b b~ WEIGHTED<=3 @1
C     Process: d d~ > g u u~ WEIGHTED<=3 @1
C     Process: d d~ > g c c~ WEIGHTED<=3 @1
C     Process: d d~ > g s s~ WEIGHTED<=3 @1
C     Process: d d~ > g b b~ WEIGHTED<=3 @1
C     Process: b b~ > g u u~ WEIGHTED<=3 @1
C     Process: b b~ > g c c~ WEIGHTED<=3 @1
C     Process: b b~ > g s s~ WEIGHTED<=3 @1
C     Process: b b~ > g d d~ WEIGHTED<=3 @1
C     Process: u c~ > g u c~ WEIGHTED<=3 @1
C     Process: u s~ > g u s~ WEIGHTED<=3 @1
C     Process: u d~ > g u d~ WEIGHTED<=3 @1
C     Process: u b~ > g u b~ WEIGHTED<=3 @1
C     Process: c u~ > g c u~ WEIGHTED<=3 @1
C     Process: c s~ > g c s~ WEIGHTED<=3 @1
C     Process: c d~ > g c d~ WEIGHTED<=3 @1
C     Process: c b~ > g c b~ WEIGHTED<=3 @1
C     Process: s u~ > g s u~ WEIGHTED<=3 @1
C     Process: s c~ > g s c~ WEIGHTED<=3 @1
C     Process: s d~ > g s d~ WEIGHTED<=3 @1
C     Process: s b~ > g s b~ WEIGHTED<=3 @1
C     Process: d u~ > g d u~ WEIGHTED<=3 @1
C     Process: d c~ > g d c~ WEIGHTED<=3 @1
C     Process: d s~ > g d s~ WEIGHTED<=3 @1
C     Process: d b~ > g d b~ WEIGHTED<=3 @1
C     Process: b u~ > g b u~ WEIGHTED<=3 @1
C     Process: b c~ > g b c~ WEIGHTED<=3 @1
C     Process: b s~ > g b s~ WEIGHTED<=3 @1
C     Process: b d~ > g b d~ WEIGHTED<=3 @1
C     Process: u~ c~ > g u~ c~ WEIGHTED<=3 @1
C     Process: u~ s~ > g u~ s~ WEIGHTED<=3 @1
C     Process: u~ d~ > g u~ d~ WEIGHTED<=3 @1
C     Process: u~ b~ > g u~ b~ WEIGHTED<=3 @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > g u u
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u~ > g u u~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u~ u~ > g u~ u~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u c > g u c
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u u~ > g c c~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u c~ > g u c~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u~ c~ > g u~ c~
      ENDIF
