...
C     
C     Process: g u > g g u WEIGHTED<=3 @1
C     Process: g c > g g c WEIGHTED<=3 @1
C     Process: g s > g g s WEIGHTED<=3 @1
C     Process: g d > g g d WEIGHTED<=3 @1
C     Process: g b > g g b WEIGHTED<=3 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,7),W(1,6),GC_11,AMP(1))
      CALL FFV1_2(W(1,2),W(1,4),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,5),W(1,6),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,6),W(1,4),W(1,9),GC_10,AMP(3))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10,ZERO,ZERO,W(1,6))
      CALL FFV1_1(W(1,5),W(1,3),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,2),W(1,10),W(1,6),GC_11,AMP(4))
      CALL FFV1_2(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,5),W(1,6),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,6),W(1,3),W(1,9),GC_10,AMP(6))
      CALL FFV1_1(W(1,5),W(1,1),GC_11,ZERO,ZERO,W(1,6))
      CALL VVV1P0_1(W(1,3),W(1,4),GC_10,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,6),W(1,12),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,11),W(1,6),W(1,4),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,8),W(1,6),W(1,3),GC_11,AMP(9))
      CALL FFV1_2(W(1,2),W(1,1),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,5),W(1,12),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,6),W(1,10),W(1,4),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,7),W(1,3),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL VVV1_0(W(1,1),W(1,12),W(1,9),GC_10,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,8),W(1,10),W(1,1),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,11),W(1,7),W(1,1),GC_11,AMP(15))
      CALL VVVV1P0_1(W(1,1),W(1,3),W(1,4),GC_12,ZERO,ZERO,W(1,11))
      CALL VVVV3P0_1(W(1,1),W(1,3),W(1,4),GC_12,ZERO,ZERO,W(1,7))
      CALL VVVV4P0_1(W(1,1),W(1,3),W(1,4),GC_12,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,5),W(1,11),GC_11,AMP(16))
      CALL FFV1_0(W(1,2),W(1,5),W(1,7),GC_11,AMP(17))
      CALL FFV1_0(W(1,2),W(1,5),W(1,10),GC_11,AMP(18))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-IMAG1*AMP(2)-AMP(3)-IMAG1*AMP(7)+AMP(9)-AMP(13)
     $ +AMP(18)-AMP(16)
      JAMP(2,1)=-IMAG1*AMP(5)-AMP(6)+IMAG1*AMP(7)+AMP(8)+AMP(13)
     $ +AMP(17)+AMP(16)
      JAMP(3,1)=+IMAG1*AMP(2)+AMP(3)-IMAG1*AMP(4)+AMP(6)+AMP(14)
     $ -AMP(18)-AMP(17)
      JAMP(4,1)=+IMAG1*AMP(4)-AMP(6)-IMAG1*AMP(10)+AMP(11)+AMP(13)
     $ +AMP(17)+AMP(16)
      JAMP(5,1)=-IMAG1*AMP(1)+AMP(3)+IMAG1*AMP(5)+AMP(6)+AMP(15)
     $ -AMP(18)-AMP(17)
      JAMP(6,1)=+IMAG1*AMP(1)-AMP(3)+IMAG1*AMP(10)+AMP(12)-AMP(13)
     $ +AMP(18)-AMP(16)
