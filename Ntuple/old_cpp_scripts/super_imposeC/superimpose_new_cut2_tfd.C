{
  ...
  TFile *rootfile_bckg = new TFile( "/home/fozturk/Desktop/Analysis-master/analyze_output_new_tfd/cut2/analyze_sm_diphoton_bckg_all_cut2.root", "READ" );
	TFile *rootfile_signal = new TFile( "/home/fozturk/Desktop/Analysis-master/analyze_output_new_tfd/cut2/analyze_signal_diphoton_cut2.root", "READ" );
  ...
  //------------------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------------------
	 ...
	 //------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize, bckg_histPhotonSize, signal_histPhotonSize , "Cut 2 Photon Size", "Size (GeV)", "Events", 0, 0);
		canvas_PhotonSize->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonSize.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize_barrel, bckg_histPhotonSize_barrel, signal_histPhotonSize_barrel , "Cut 2 Photon Size_barrel", "Size_barrel (GeV)", "Events", 0, 0);
		canvas_PhotonSize_barrel->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonSize_barrel.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize_endcap, bckg_histPhotonSize_endcap, signal_histPhotonSize_endcap , "Cut 2 Photon Size_endcap", "Size_endcap (GeV)", "Events", 0, 0);
		canvas_PhotonSize_endcap->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonSize_endcap.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize_endbar, bckg_histPhotonSize_endbar, signal_histPhotonSize_endbar , "Cut 2 Photon Size_endbar", "Size_endbar (GeV)", "Events", 0, 0);
		canvas_PhotonSize_endbar->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonSize_endbar.eps");
		...
		hist_same (canvas_PhotonPT, bckg_histPhotonPT, signal_histPhotonPT , "Cut 2 All Photon PT", "PT (GeV)", "Events", 0, 0);
		canvas_PhotonPT->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonPT.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonEta, bckg_histPhotonEta, signal_histPhotonEta , "Cut 2 All Photon Eta", "Eta (GeV)", "Events", 0, 0);
		canvas_PhotonEta->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonPhi, bckg_histPhotonPhi, signal_histPhotonPhi , "Cut 2 All Photon Phi", "Phi (GeV)", "Events", 0, 0);
		canvas_PhotonPhi->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonPhi.eps");
		...
		hist_same (canvas_PhotonPT_1, bckg_histPhotonPT_1, signal_histPhotonPT_1 , "Cut 2 Photon PT_1", "PT_1 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonPT_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonEta_1, bckg_histPhotonEta_1, signal_histPhotonEta_1 , "Cut 2 Photon Eta_1", "Eta_1 (GeV)", "Events", 0, 0);
		canvas_PhotonEta_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonEta_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonPhi_1, bckg_histPhotonPhi_1, signal_histPhotonPhi_1 , "Cut 2 Photon Phi_1", "Phi_1 (GeV)", "Events", 0, 0);
		canvas_PhotonPhi_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonPhi_1.eps");
		...
		hist_same (canvas_PhotonPT_2, bckg_histPhotonPT_2, signal_histPhotonPT_2 , "Cut 2 Photon PT_2", "PT_2 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_2->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonPT_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonEta_2, bckg_histPhotonEta_2, signal_histPhotonEta_2 , "Cut 2 Photon Eta_2", "Eta_2 (GeV)", "Events", 0, 0);
		canvas_PhotonEta_2->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonEta_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonPhi_2, bckg_histPhotonPhi_2, signal_histPhotonPhi_2 , "Cut 2 Photon Phi_2", "Phi_2 (GeV)", "Events", 0, 0);
		canvas_PhotonPhi_2->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonPhi_2.eps");
		...
		hist_same (canvas_PhotonDeltaEta, bckg_histPhotonDeltaEta, signal_histPhotonDeltaEta , "Cut 2 Photon Delta_Eta", "Delta_Eta (GeV)", "Events", 0, 0);
		canvas_PhotonDeltaEta->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonDeltaEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonDeltaPhi, bckg_histPhotonDeltaPhi, signal_histPhotonDeltaPhi , "Cut 2 Photon Delta_Phi", "Delta_Phi (GeV)", "Events", 0, 0);
		canvas_PhotonDeltaPhi->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonDeltaPhi.eps");
		...
		hist_same (canvas_PhotonDeltaR, bckg_histPhotonDeltaR, signal_histPhotonDeltaR , "Cut 2 Photon DeltaR", "DeltaR (GeV)", "Events", 0, 0);
		canvas_PhotonDeltaR->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonDeltaR.eps");
		...
		hist_same (canvas_PhotonHT, bckg_histPhotonHT, signal_histPhotonHT , "Cut 2 All Photon HT", "HT (GeV)", "Events", 0, 0);
		//bckg_histPhotonHT->GetXaxis()->SetRangeUser(0,1000);
		canvas_PhotonHT->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonHT.eps");
		...
		hist_same (canvas_PhotonE, bckg_histPhotonE, signal_histPhotonE , "Cut 2 All Photon E", "E (GeV)", "Events", 0, 0);
		canvas_PhotonE->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonE.eps");
		...
		hist_same (canvas_PhotonInvMass, bckg_histPhotonInvMass, signal_histPhotonInvMass , "Cut 2 Photon 1 and Photon 2 Inv Mass", "InvMass (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonInvMass.eps");
		...
		hist_same (canvas_PhotonInvMass_barrel, bckg_histPhotonInvMass_barrel, signal_histPhotonInvMass_barrel , "Cut 2 Photon 1 and Photon 2 Inv Mass Barrel", "InvMass_barrel (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass_barrel->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonInvMass_barrel.eps");
		...
		hist_same (canvas_PhotonInvMass_endcap, bckg_histPhotonInvMass_endcap, signal_histPhotonInvMass_endcap , "Cut 2 Photon 1 and Photon 2 Inv Mass Endcap", "InvMass_endcap (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass_endcap->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonInvMass_endcap.eps");
		...
		hist_same (canvas_PhotonInvMass_endbar, bckg_histPhotonInvMass_endbar, signal_histPhotonInvMass_endbar , "Cut 2 Photon 1 and Photon 2 Inv Mass", "InvMass_endbar (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass_endbar->Print("plots_new_tfd/cut2_hadd/cut2_hadd_PhotonInvMass_endbar.eps");
		...
		hist_same (canvas_JetSize, bckg_histJetSize, signal_histJetSize , "Cut 2 Jet Size", "Size (GeV)", "Events", 0, 0);
		canvas_JetSize->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetSize.eps");
		...
		hist_same (canvas_JetSize_cut, bckg_histJetSize_cut, signal_histJetSize_cut , "Cut 2 Jet Size_cut", "Size_cut (GeV)", "Events", 0, 0);
		canvas_JetSize_cut->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetSize_cut.eps");
		...
		hist_same (canvas_JetPT, bckg_histJetPT, signal_histJetPT , "Cut 2 All Jet PT", "PT (GeV)", "Events", 0, 0);
		canvas_JetPT->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetPT.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetEta, bckg_histJetEta, signal_histJetEta , "Cut 2 All Jet Eta", "Eta (GeV)", "Events", 0, 0);
		canvas_JetEta->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetPhi, bckg_histJetPhi, signal_histJetPhi , "Cut 2 All Jet Phi", "Phi (GeV)", "Events", 0, 0);
		canvas_JetPhi->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetPhi.eps");
		...
		hist_same (canvas_JetPT_1, bckg_histJetPT_1, signal_histJetPT_1 , "Cut 2 Jet PT_1", "PT_1 (GeV)", "Events", 0, 0);
		canvas_JetPT_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetPT_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetEta_1, bckg_histJetEta_1, signal_histJetEta_1 , "Cut 2 Jet Eta_1", "Eta_1 (GeV)", "Events", 0, 0);
		canvas_JetEta_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetEta_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetPhi_1, bckg_histJetPhi_1, signal_histJetPhi_1 , "Cut 2 Jet Phi_1", "Phi_1 (GeV)", "Events", 0, 0);
		canvas_JetPhi_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetPhi_1.eps");
		...
		hist_same (canvas_JetPT_2, bckg_histJetPT_2, signal_histJetPT_2 , "Cut 2 Jet PT_2", "PT_2 (GeV)", "Events", 0, 0);
		canvas_JetPT_2->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetPT_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetEta_2, bckg_histJetEta_2, signal_histJetEta_2 , "Cut 2 Jet Eta_2", "Eta_2 (GeV)", "Events", 0, 0);
		canvas_JetEta_2->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetEta_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetPhi_2, bckg_histJetPhi_2, signal_histJetPhi_2 , "Cut 2 Jet Phi_2", "Phi_2 (GeV)", "Events", 0, 0);
		canvas_JetPhi_2->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetPhi_2.eps");
		...
		hist_same (canvas_JetDeltaEta, bckg_histJetDeltaEta, signal_histJetDeltaEta , "Cut 2 Jet DeltaEta", "DeltaEta (GeV)", "Events", 0, 0);
		canvas_JetDeltaEta->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetDeltaEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetDeltaPhi, bckg_histJetDeltaPhi, signal_histJetDeltaPhi , "Cut 2 Jet DeltaPhi", "DeltaPhi (GeV)", "Events", 0, 0);
		canvas_JetDeltaPhi->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetDeltaPhi.eps");
		...
		hist_same (canvas_JetDeltaR, bckg_histJetDeltaR, signal_histJetDeltaR , "Cut 2 Jet DeltaR", "DeltaR (GeV)", "Events", 0, 0);
		canvas_JetDeltaR->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetDeltaR.eps");
		...
		hist_same (canvas_JetDeltaEta_1, bckg_histJetDeltaEta_1, signal_histJetDeltaEta_1 , "Cut 2 Jet DeltaEta_1", "DeltaEta_1 (GeV)", "Events", 0, 0);
		canvas_JetDeltaEta_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetDeltaEta_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetDeltaPhi_1, bckg_histJetDeltaPhi_1, signal_histJetDeltaPhi_1 , "Cut 2 Jet DeltaPhi_1", "DeltaPhi_1 (GeV)", "Events", 0, 0);
		canvas_JetDeltaPhi_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetDeltaPhi_1.eps");
		...
		hist_same (canvas_JetDeltaR_1, bckg_histJetDeltaR_1, signal_histJetDeltaR_1 , "Cut 2 Jet DeltaR_1", "DeltaR_1 (GeV)", "Events", 0, 0);
		canvas_JetDeltaR_1->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetDeltaR_1.eps");
		...
		hist_same (canvas_JetMass, bckg_histJetMass, signal_histJetMass , "Cut 2 All Jet Mass", "Mass (GeV)", "Events", 0, 0.);
		canvas_JetMass->Print("plots_new_tfd/cut2_hadd/cut2_hadd_JetMass.eps");
		...
		hist_same (canvas_Ht, bckg_histHt, signal_histHt , "Cut 2 Event HT", "HT (GeV)", "Events", 0, 0.);
		canvas_Ht->Print("plots_new_tfd/cut2_hadd/cut2_hadd_Ht.eps");
		...
		hist_same (canvas_Met, bckg_histMet, signal_histMet , "Cut 2 Event MET", "MET (GeV)", "Events", 0, 0.);
		canvas_Met->Print("plots_new_tfd/cut2_hadd/cut2_hadd_Met.eps");
		...
		hist_same (canvas_MetEta, bckg_histMetEta, signal_histMetEta , "Cut 2 Event MET Eta", "Eta", "Events", 0, 0.);
		canvas_MetEta->Print("plots_new_tfd/cut2_hadd/cut2_hadd_MetEta.eps");
		...
		hist_same (canvas_MuonSize, bckg_histMuonSize, signal_histMuonSize , "Cut 2 Muon Size", "Size (GeV)", "Events", 0, 0);
		canvas_MuonSize->Print("plots_new_tfd/cut2_hadd/cut2_hadd_MuonSize.eps");
		...
		hist_same (canvas_ElectronSize, bckg_histElectronSize, signal_histElectronSize , "Cut 2 Electron Size", "Size (GeV)", "Events", 0, 0);
		canvas_ElectronSize->Print("plots_new_tfd/cut2_hadd/cut2_hadd_ElectronSize.eps");
		...
		hist_same (canvas_LeptonSize, bckg_histLeptonSize, signal_histLeptonSize , "Cut 2 Lepton Size", "Size (GeV)", "Events", 0, 0);
		canvas_LeptonSize->Print("plots_new_tfd/cut2_hadd/cut2_hadd_LeptonSize.eps");
