{
  ...
  TFile *rootfile_bckg = new TFile( "/home/fozturk/Desktop/Analysis-master/analyze_output_new_tfd/cut0/analyze_sm_diphoton_bckg_all_cut0.root", "READ" );
	TFile *rootfile_signal = new TFile( "/home/fozturk/Desktop/Analysis-master/analyze_output_new_tfd/cut0/analyze_signal_diphoton_cut0.root", "READ" );
  ...
  //------------------------------------------------------------------------------------
	...
	TH1F *bckg_histPhotonPT_1_1   = (TH1F*)rootfile_bckg->Get("Photon/photon_1_pt_1");
	TH1F *bckg_histPhotonPT_1_2   = (TH1F*)rootfile_bckg->Get("Photon/photon_1_pt_2");
	TH1F *bckg_histPhotonPT_1_3   = (TH1F*)rootfile_bckg->Get("Photon/photon_1_pt_3");
	...
	TH1F *signal_histPhotonPT_1_1       = (TH1F*)rootfile_signal->Get("Photon/photon_1_pt_1");
	TH1F *signal_histPhotonPT_1_2       = (TH1F*)rootfile_signal->Get("Photon/photon_1_pt_2");
	TH1F *signal_histPhotonPT_1_3       = (TH1F*)rootfile_signal->Get("Photon/photon_1_pt_3");
	...
	//------------------------------------------------------------------------------------
	 ...
	 //------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize, bckg_histPhotonSize, signal_histPhotonSize , "Before Trigger Photon Size", "Size (GeV)", "Events", 0, 0);
		canvas_PhotonSize->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonSize.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize_barrel, bckg_histPhotonSize_barrel, signal_histPhotonSize_barrel , "Before Trigger Photon Size_barrel", "Size_barrel (GeV)", "Events", 0, 0);
		canvas_PhotonSize_barrel->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonSize_barrel.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize_endcap, bckg_histPhotonSize_endcap, signal_histPhotonSize_endcap , "Before Trigger Photon Size_endcap", "Size_endcap (GeV)", "Events", 0, 0);
		canvas_PhotonSize_endcap->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonSize_endcap.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonSize_endbar, bckg_histPhotonSize_endbar, signal_histPhotonSize_endbar , "Before Trigger Photon Size_endbar", "Size_endbar (GeV)", "Events", 0, 0);
		canvas_PhotonSize_endbar->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonSize_endbar.eps");
		...
		hist_same (canvas_PhotonPT, bckg_histPhotonPT, signal_histPhotonPT , "Before Trigger All Photon PT", "PT (GeV)", "Events", 0, 0);
		canvas_PhotonPT->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPT.eps");


		//bckg_histPhotonPT_1_1->Scale(1/bckg_histPhotonPT_1_1->Integral());

		signal_histPhotonPT_1_1->Scale( signal_cross);
		//signal_histPhotonPT_1_1->Scale(1/signal_histPhotonPT_1_1->Integral());

		TCanvas *canvas_PhotonPT_1_1 = new TCanvas("canvas_PhotonPT_1_1","title",2500,0,600,500);
		hist_same (canvas_PhotonPT_1_1, bckg_histPhotonPT_1_1, signal_histPhotonPT_1_1 , "Before Trigger All Photon PT_1_1", "PT_1_1 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_1_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPT_1_1.eps");


		//bckg_histPhotonPT_1_2->Scale(1/bckg_histPhotonPT_1_2->Integral());

		signal_histPhotonPT_1_2->Scale( signal_cross);
		//signal_histPhotonPT_1_2->Scale(1/signal_histPhotonPT_1_2->Integral());

		TCanvas *canvas_PhotonPT_1_2 = new TCanvas("canvas_PhotonPT_1_2","title",2500,0,600,500);
		hist_same (canvas_PhotonPT_1_2, bckg_histPhotonPT_1_2, signal_histPhotonPT_1_2 , "Before Trigger All Photon PT_1_2", "PT_1_2 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_1_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPT_1_2.eps");


		//bckg_histPhotonPT_1_3->Scale(1/bckg_histPhotonPT_1_3->Integral());

		signal_histPhotonPT_1_3->Scale( signal_cross);
		//signal_histPhotonPT_1_3->Scale(1/signal_histPhotonPT_1_3->Integral());

		TCanvas *canvas_PhotonPT_1_3 = new TCanvas("canvas_PhotonPT_1_3","title",2500,0,600,500);
		hist_same (canvas_PhotonPT_1_3, bckg_histPhotonPT_1_3, signal_histPhotonPT_1_3 , "Before Trigger All Photon PT_1_3", "PT_1_3 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_1_3->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPT_1_3.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonEta, bckg_histPhotonEta, signal_histPhotonEta , "Before Trigger All Photon Eta", "Eta (GeV)", "Events", 0, 0);
		canvas_PhotonEta->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonPhi, bckg_histPhotonPhi, signal_histPhotonPhi , "Before Trigger All Photon Phi", "Phi (GeV)", "Events", 0, 0);
		canvas_PhotonPhi->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPhi.eps");
		...
		hist_same (canvas_PhotonPT_1, bckg_histPhotonPT_1, signal_histPhotonPT_1 , "Before Trigger Photon PT_1", "PT_1 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPT_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonEta_1, bckg_histPhotonEta_1, signal_histPhotonEta_1 , "Before Trigger Photon Eta_1", "Eta_1 (GeV)", "Events", 0, 0);
		canvas_PhotonEta_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonEta_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonPhi_1, bckg_histPhotonPhi_1, signal_histPhotonPhi_1 , "Before Trigger Photon Phi_1", "Phi_1 (GeV)", "Events", 0, 0);
		canvas_PhotonPhi_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPhi_1.eps");
		...
		hist_same (canvas_PhotonPT_2, bckg_histPhotonPT_2, signal_histPhotonPT_2 , "Before Trigger Photon PT_2", "PT_2 (GeV)", "Events", 0, 0);
		canvas_PhotonPT_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPT_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonEta_2, bckg_histPhotonEta_2, signal_histPhotonEta_2 , "Before Trigger Photon Eta_2", "Eta_2 (GeV)", "Events", 0, 0);
		canvas_PhotonEta_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonEta_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonPhi_2, bckg_histPhotonPhi_2, signal_histPhotonPhi_2 , "Before Trigger Photon Phi_2", "Phi_2 (GeV)", "Events", 0, 0);
		canvas_PhotonPhi_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonPhi_2.eps");
		...
		hist_same (canvas_PhotonDeltaEta, bckg_histPhotonDeltaEta, signal_histPhotonDeltaEta , "Before Trigger Photon Delta_Eta", "Delta_Eta (GeV)", "Events", 0, 0);
		canvas_PhotonDeltaEta->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonDeltaEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_PhotonDeltaPhi, bckg_histPhotonDeltaPhi, signal_histPhotonDeltaPhi , "Before Trigger Photon Delta_Phi", "Delta_Phi (GeV)", "Events", 0, 0);
		canvas_PhotonDeltaPhi->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonDeltaPhi.eps");
		...
		hist_same (canvas_PhotonDeltaR, bckg_histPhotonDeltaR, signal_histPhotonDeltaR , "Before Trigger Photon DeltaR", "DeltaR (GeV)", "Events", 0, 0);
		canvas_PhotonDeltaR->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonDeltaR.eps");
		...
		hist_same (canvas_PhotonHT, bckg_histPhotonHT, signal_histPhotonHT , "Before Trigger All Photon HT", "HT (GeV)", "Events", 0, 0);
		//bckg_histPhotonHT->GetXaxis()->SetRangeUser(0,1000);
		canvas_PhotonHT->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonHT.eps");
		...
		hist_same (canvas_PhotonE, bckg_histPhotonE, signal_histPhotonE , "Before Trigger All Photon E", "E (GeV)", "Events", 0, 0);
		canvas_PhotonE->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonE.eps");
		...
		hist_same (canvas_PhotonInvMass, bckg_histPhotonInvMass, signal_histPhotonInvMass , "Before Trigger Photon 1 and Photon 2 Inv Mass", "InvMass (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonInvMass.eps");
		...
		hist_same (canvas_PhotonInvMass_barrel, bckg_histPhotonInvMass_barrel, signal_histPhotonInvMass_barrel , "Before Trigger Photon 1 and Photon 2 Inv Mass Barrel", "InvMass_barrel (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass_barrel->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonInvMass_barrel.eps");
		...
		hist_same (canvas_PhotonInvMass_endcap, bckg_histPhotonInvMass_endcap, signal_histPhotonInvMass_endcap , "Before Trigger Photon 1 and Photon 2 Inv Mass Endcap", "InvMass_endcap (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass_endcap->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonInvMass_endcap.eps");
		...
		hist_same (canvas_PhotonInvMass_endbar, bckg_histPhotonInvMass_endbar, signal_histPhotonInvMass_endbar , "Before Trigger Photon 1 and Photon 2 Inv Mass", "InvMass_endbar (GeV)", "Events", 0, 0);
		canvas_PhotonInvMass_endbar->Print("plots_new_tfd/cut0_hadd/cut0_hadd_PhotonInvMass_endbar.eps");
		...
		hist_same (canvas_JetSize, bckg_histJetSize, signal_histJetSize , "Before Trigger Jet Size", "Size (GeV)", "Events", 0, 0);
		canvas_JetSize->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetSize.eps");
		...
		hist_same (canvas_JetSize_cut, bckg_histJetSize_cut, signal_histJetSize_cut , "Before Trigger Jet Size_cut", "Size_cut (GeV)", "Events", 0, 0);
		canvas_JetSize_cut->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetSize_cut.eps");
		...
		hist_same (canvas_JetPT, bckg_histJetPT, signal_histJetPT , "Before Trigger All Jet PT", "PT (GeV)", "Events", 0, 0);
		canvas_JetPT->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetPT.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetEta, bckg_histJetEta, signal_histJetEta , "Before Trigger All Jet Eta", "Eta (GeV)", "Events", 0, 0);
		canvas_JetEta->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetPhi, bckg_histJetPhi, signal_histJetPhi , "Before Trigger All Jet Phi", "Phi (GeV)", "Events", 0, 0);
		canvas_JetPhi->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetPhi.eps");
		...
		hist_same (canvas_JetPT_1, bckg_histJetPT_1, signal_histJetPT_1 , "Before Trigger Jet PT_1", "PT_1 (GeV)", "Events", 0, 0);
		canvas_JetPT_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetPT_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetEta_1, bckg_histJetEta_1, signal_histJetEta_1 , "Before Trigger Jet Eta_1", "Eta_1 (GeV)", "Events", 0, 0);
		canvas_JetEta_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetEta_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetPhi_1, bckg_histJetPhi_1, signal_histJetPhi_1 , "Before Trigger Jet Phi_1", "Phi_1 (GeV)", "Events", 0, 0);
		canvas_JetPhi_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetPhi_1.eps");
		...
		hist_same (canvas_JetPT_2, bckg_histJetPT_2, signal_histJetPT_2 , "Before Trigger Jet PT_2", "PT_2 (GeV)", "Events", 0, 0);
		canvas_JetPT_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetPT_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetEta_2, bckg_histJetEta_2, signal_histJetEta_2 , "Before Trigger Jet Eta_2", "Eta_2 (GeV)", "Events", 0, 0);
		canvas_JetEta_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetEta_2.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetPhi_2, bckg_histJetPhi_2, signal_histJetPhi_2 , "Before Trigger Jet Phi_2", "Phi_2 (GeV)", "Events", 0, 0);
		canvas_JetPhi_2->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetPhi_2.eps");
		...
		hist_same (canvas_JetDeltaEta, bckg_histJetDeltaEta, signal_histJetDeltaEta , "Before Trigger Jet DeltaEta", "DeltaEta (GeV)", "Events", 0, 0);
		canvas_JetDeltaEta->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetDeltaEta.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetDeltaPhi, bckg_histJetDeltaPhi, signal_histJetDeltaPhi , "Before Trigger Jet DeltaPhi", "DeltaPhi (GeV)", "Events", 0, 0);
		canvas_JetDeltaPhi->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetDeltaPhi.eps");
		...
		hist_same (canvas_JetDeltaR, bckg_histJetDeltaR, signal_histJetDeltaR , "Before Trigger Jet DeltaR", "DeltaR (GeV)", "Events", 0, 0);
		canvas_JetDeltaR->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetDeltaR.eps");
		...
		hist_same (canvas_JetDeltaEta_1, bckg_histJetDeltaEta_1, signal_histJetDeltaEta_1 , "Before Trigger Jet DeltaEta_1", "DeltaEta_1 (GeV)", "Events", 0, 0);
		canvas_JetDeltaEta_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetDeltaEta_1.eps");
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		hist_same (canvas_JetDeltaPhi_1, bckg_histJetDeltaPhi_1, signal_histJetDeltaPhi_1 , "Before Trigger Jet DeltaPhi_1", "DeltaPhi_1 (GeV)", "Events", 0, 0);
		canvas_JetDeltaPhi_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetDeltaPhi_1.eps");
		...
		hist_same (canvas_JetDeltaR_1, bckg_histJetDeltaR_1, signal_histJetDeltaR_1 , "Before Trigger Jet DeltaR_1", "DeltaR_1 (GeV)", "Events", 0, 0);
		canvas_JetDeltaR_1->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetDeltaR_1.eps");
		...
		hist_same (canvas_JetMass, bckg_histJetMass, signal_histJetMass , "Before Trigger All Jet Mass", "Mass (GeV)", "Events", 0, 0.);
		canvas_JetMass->Print("plots_new_tfd/cut0_hadd/cut0_hadd_JetMass.eps");
		...
		hist_same (canvas_Ht, bckg_histHt, signal_histHt , "Before Trigger Event HT", "HT (GeV)", "Events", 0, 0.);
		canvas_Ht->Print("plots_new_tfd/cut0_hadd/cut0_hadd_Ht.eps");
		...
		hist_same (canvas_Met, bckg_histMet, signal_histMet , "Before Trigger Event MET", "MET (GeV)", "Events", 0, 0.);
		canvas_Met->Print("plots_new_tfd/cut0_hadd/cut0_hadd_Met.eps");
		...
		hist_same (canvas_MetEta, bckg_histMetEta, signal_histMetEta , "Before Trigger Event MET Eta", "Eta", "Events", 0, 0.);
		canvas_MetEta->Print("plots_new_tfd/cut0_hadd/cut0_hadd_MetEta.eps");
		...
		hist_same (canvas_MuonSize, bckg_histMuonSize, signal_histMuonSize , "Before Trigger Muon Size", "Size (GeV)", "Events", 0, 0);
		canvas_MuonSize->Print("plots_new_tfd/cut0_hadd/cut0_hadd_MuonSize.eps");
		...
		hist_same (canvas_ElectronSize, bckg_histElectronSize, signal_histElectronSize , "Before Trigger Electron Size", "Size (GeV)", "Events", 0, 0);
		canvas_ElectronSize->Print("plots_new_tfd/cut0_hadd/cut0_hadd_ElectronSize.eps");
		...
		hist_same (canvas_LeptonSize, bckg_histLeptonSize, signal_histLeptonSize , "Before Trigger Lepton Size", "Size (GeV)", "Events", 0, 0);
		canvas_LeptonSize->Print("plots_new_tfd/cut0_hadd/cut0_hadd_LeptonSize.eps");
