...
int main(int argc, char*argv[])
{
    ...
    TH1F  *histJet_size_cut   = new TH1F("jet_size_cut"	 ,   "JET SIZE IN HCAL",  15,      0.0,   15.0);
    ...
    TH1F  *histJet_deltaphi  	= new TH1F("jet_delta_phi"   , "Jet Delta Phi  ",   100.0,  -1.0,   3.0);
    TH1F  *histJet_deltaeta  	= new TH1F("jet_delta_eta"   , "Jet Delta Eta  ",   100.0,  -1.0,   7.0);
    TH1F  *histJet_deltar   	= new TH1F("jet_deltar"      , "Jet DeltaR ",       100.0,   0.,    6.);
    TH1F  *histJet_deltaphi_1 = new TH1F("jet_delta_phi_1" , "Jet Delta Phi 1 ",  100.0,  -1.0,   5.0);
    TH1F  *histJet_deltaeta_1 = new TH1F("jet_delta_eta_1" , "Jet Delta Eta 1 ",  100.0,  -7.0,   7.0);
    TH1F  *histJet_deltar_1  	= new TH1F("jet_deltar_1"    , "Jet DeltaR 1 ",     100.0,   0.,    8.);
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    TH1F *histPhoton_size_barrel     = new TH1F("photon_size_barrel" , "PHOTON BARREL",      5,       0.0,   5.0);
    TH1F *histPhoton_size_endcap     = new TH1F("photon_size_endcap" , "PHOTON ENDCAP",      5,       0.0,   5.0);
    TH1F *histPhoton_size_endbar     = new TH1F("photon_size_endbar" , "PHOTON BARREL and ENDCAP",      5,       0.0,   5.0);
    TH1F *histPhoton_eta    	       = new TH1F("photon_eta"         , "Photon Eta",         100.0,  -5.0,  5.0);
    TH1F *histPhoton_phi    	       = new TH1F("photon_phi"         , "Photon Phi",         100.0,  -3.5,   3.5);
    TH1F *histPhoton_eta_1    	     = new TH1F("photon_eta_1"       , "Photon Eta 1",       100.0,  -5.0,  5.0);
  	TH1F *histPhoton_phi_1    	     = new TH1F("photon_phi_1"       , "Photon Phi 1",       100.0,  -3.5,   3.5);
    TH1F *histPhoton_eta_2    	     = new TH1F("photon_eta_2"       , "Photon Eta 2",       100.0,  -5.0,   5.0);
    ...
    TH1F *histPhoton_ht     	       = new TH1F("photon_ht"          , "Photon HT" ,   		   100.0,   0.0,   3500.0);
  	TH1F *histPhoton_pt     	       = new TH1F("photon_pt"          , "Photon PT" ,   		   100.0,   0.0,   2000.0);
    TH1F *histPhoton_1_pt_1          = new TH1F("photon_1_pt_1"      , "1 Foton İceren Olayların PT'si",   100.0,   0.0,   2000.0);
    TH1F *histPhoton_1_pt_2          = new TH1F("photon_1_pt_2"      , "2 Foton İceren Olayların PT'si" ,  100.0,   0.0,   2000.0);
    TH1F *histPhoton_1_pt_3          = new TH1F("photon_1_pt_3"      , "3 Foton İceren Olayların PT'si",   100.0,   0.0,   2000.0);
  	TH1F *histPhoton_pt_1            = new TH1F("photon_pt_1"        , "Photon PT Leading",  100.0,   0.0,   2000.0);
  	TH1F *histPhoton_pt_2            = new TH1F("photon_pt_2"        , "Photon PT Second" ,  100.0,   0.0,   1500.0);
  	TH1F *histPhoton_deltaphi        = new TH1F("photon_delta_phi"   , "Photon Delta Phi",   100.0,  -1.0,   5.0);
  	TH1F *histPhoton_deltaeta        = new TH1F("photon_delta_eta"   , "Photon Delta Eta",   100.0,  -7.0,   7.0);
  	TH1F *histPhoton_deltar          = new TH1F("photon_deltar"      , "Photon DeltaR",   	 100.0,   0.,    8.);
  	TH1F *histPhoton_invmass	       = new TH1F("photon_invmass"     , "Photon Inv Mass",    100.0,   0.,    1200.);
    TH1F *histPhoton_invmass_barrel	 = new TH1F("photon_invmass_barrel"     , "Photon Inv Mass In BARREL",    100.0,   0.,    1200.);
    TH1F *histPhoton_invmass_endcap	 = new TH1F("photon_invmass_endcap"     , "Photon Inv Mass In ENDCAP",    100.0,   0.,    1200.);
    TH1F *histPhoton_invmass_endbar	 = new TH1F("photon_invmass_endbar"     , "Photon Inv Mass AT LEAST ONE PHOTON IN BARREL",    100.0,   0.,    1200.);
    TH1F *histPhoton_pt_reso     	   = new TH1F("photon_pt_reso"            , "(Photon PT 1 - Photon PT2) / (PT 1 + PT 2)" ,
      		                                                                                  100.0,   0.0,   1000.0);
    ...
    TDirectory *photonjet_dir= outf->mkdir("PhotonJet");
  	photonjet_dir->cd();

    TH1F *histPhotonJet_pt     	        = new TH1F("photonjet_pt"          , "Delta PT  (First Photon - First Jet)" ,  100.0,   0.0,   2000.0);
    TH1F *histPhotonJet_deltaphi        = new TH1F("photonjet_delta_phi"   , "Delta Phi (First Photon and Jet)",   100.0,  -1.0,   5.0);
    TH1F *histPhotonJet_deltaeta        = new TH1F("photonjet_delta_eta"   , "Delta Eta (First Photon and Jet)",   100.0,  -7.0,   7.0);
    TH1F *histPhotonJet_deltar          = new TH1F("photonjet_deltar"      , "DeltaR (First Photon and Jet)",   	 100.0,   0.,    8.);

    TH1F *histPhotonJet_pt_1     	        = new TH1F("photonjet_pt_1"          , "Delta PT  (Second Photon - Second Jet)" ,  100.0,   0.0,   2000.0);
    TH1F *histPhotonJet_deltaphi_1        = new TH1F("photonjet_delta_phi_1"   , "Delta Phi (Second Photon and Jet)",   100.0,  -1.0,   5.0);
    TH1F *histPhotonJet_deltaeta_1        = new TH1F("photonjet_delta_eta_1"   , "Delta Eta (Second Photon and Jet)",   100.0,  -7.0,   7.0);
    TH1F *histPhotonJet_deltar_1          = new TH1F("photonjet_deltar_1"      , "DeltaR (Second Photon and Jet)",   	  100.0,   0.,    8.);
    ...
    int counter_cut0_event=0;
    int counter_cut0_photon = 0;
    int counter_cut0_photon_0 = 0;
    int counter_cut0_photon_1 = 0;
    int counter_cut0_photon_2 = 0;
    int counter_cut0_photon_3 = 0;
    int counter_cut0_photon_4 = 0;
    int counter_cut0_muon = 0;
    int counter_cut0_electron = 0;
    int counter_cut0_lepton = 0;

    int photon_counter_barrel=0;
    int photon_counter_endcap=0;
    int photon_counter_endbar=0;
    ...
    int photon_counter_barrel_1=0;
    int photon_counter_endcap_1=0;
    int photon_counter_endbar_1=0;
    ...
    for (int i=0; i< NPHOTON_MAX; i++)
    {
                ...
                if( abs(photon[i].Eta) > 1.57  && abs(photon[i].Eta) < 2.50) {
                photon_counter_endcap++;
                photon_counter_endcap_1++;
                }

                if( abs(photon[i].Eta) < 1.44){
                photon_counter_barrel++;
                photon_counter_barrel_1++;

                }

                if( abs(photon[i].Eta) < 2.50){
                photon_counter_endbar++;
                photon_counter_endbar_1++;
                }

                if(photon_counter == 1) histPhoton_1_pt_1->Fill(photon[i].PT);
                if(photon_counter == 2) histPhoton_1_pt_2->Fill(photon[i].PT);
                if(photon_counter == 3) histPhoton_1_pt_3->Fill(photon[i].PT);

    }

    histPhoton_size->Fill(photon_counter);

    histPhoton_size_endcap->Fill(photon_counter_endcap_1);
    histPhoton_size_barrel->Fill(photon_counter_barrel_1);
    histPhoton_size_endbar->Fill(photon_counter_endbar_1);
    ...
    if(photon_counter > 1){
      ...
      if( abs(photon[0].Eta) > 1.57  && abs(photon[1].Eta) > 1.57 &&
          abs(photon[0].Eta) < 2.50  && abs(photon[1].Eta) < 2.50){

            histPhoton_invmass_endcap->Fill(photon_invariant_mass(photon[0], photon[1]));
      }

      if( abs(photon[0].Eta) < 1.44  && abs(photon[1].Eta) < 1.44){

            histPhoton_invmass_barrel->Fill(photon_invariant_mass(photon[0], photon[1]));
      }

      if( ( abs(photon[0].Eta) < 1.44 || abs(photon[1].Eta) < 1.44 )  &&
          abs(photon[0].Eta) < 2.50  && abs(photon[1].Eta) < 2.50){

            histPhoton_invmass_endbar->Fill(photon_invariant_mass(photon[0], photon[1]));
      }


    }
    if(photon_counter > 1) histPhoton_pt_reso->Fill((photon[0].PT - photon[1].PT)/photon_ht_value);
    ...
    if(jet_counter > 0 && photon_counter > 0) {

      histPhotonJet_pt->Fill(photon[0].PT-jet[0].PT);

      delta_Phi = TMath::Abs(photon[0].Phi-jet[0].Phi);
      delta_Eta = photon[0].Eta-jet[0].Eta;
      if(delta_Phi > TMath::Pi()) delta_Phi = TMath::TwoPi() - delta_Phi;
      delta_R=TMath::Sqrt(delta_Eta*delta_Eta + delta_Phi*delta_Phi);

      histPhotonJet_deltaeta->Fill(delta_Eta);
      histPhotonJet_deltaphi->Fill(delta_Phi);
      histPhotonJet_deltar->Fill(delta_R);

    }

    if(jet_counter > 1 && photon_counter > 1) {

      histPhotonJet_pt_1->Fill(photon[1].PT-jet[1].PT);

      delta_Phi = TMath::Abs(photon[1].Phi-jet[1].Phi);
      delta_Eta = photon[1].Eta-jet[1].Eta;
      if(delta_Phi > TMath::Pi()) delta_Phi = TMath::TwoPi() - delta_Phi;
      delta_R=TMath::Sqrt(delta_Eta*delta_Eta + delta_Phi*delta_Phi);

      histPhotonJet_deltaeta_1->Fill(delta_Eta);
      histPhotonJet_deltaphi_1->Fill(delta_Phi);
      histPhotonJet_deltar_1->Fill(delta_R);
    ...
    ///////////////////////////////////////////////////////////////////////////
      ...
      if(photon_counter > 0)  counter_cut0_photon = counter_cut0_photon + photon_counter;
			if(photon_counter == 0) counter_cut0_photon_0++;
    	if(photon_counter == 1) counter_cut0_photon_1++;
    	if(photon_counter == 2) counter_cut0_photon_2++;
    	if(photon_counter == 3) counter_cut0_photon_3++;
			if(photon_counter == 4) counter_cut0_photon_4++;

    	if(muon_counter  > 0) counter_cut0_muon = counter_cut0_muon + muon_counter;
    	if(electron_counter_cut > 0)  counter_cut0_electron = counter_cut0_electron + electron_counter;
    	if(muon_counter  > 0 || electron_counter > 0)  counter_cut0_lepton = counter_cut0_lepton + muon_counter + electron_counter;
    ...
    std::cout << "Photon Barrels Numbers: " << photon_counter_barrel << std::endl;
    std::cout << "Photon EndCap  Numbers: " << photon_counter_endcap << std::endl;
    std::cout << "Photon EndBar  Numbers: " << photon_counter_endbar << std::endl;
    ...
    //---------------------------------------------------------------------------------------------------------
  	...
  	cout << "---------------------------------------------------------------------------------------------" << endl;
  	cout << "Cut 0 Event number:  " 	   << counter_cut0_event    << endl;
  	cout << "Cut 0 Photon All number:  " << counter_cut0_photon   << endl;
  	cout << "Cut 0 Photon 0 number:  "	 << counter_cut0_photon_0 << endl;
  	cout << "Cut 0 Photon 1 number:  "	 << counter_cut0_photon_1 << endl;
  	cout << "Cut 0 Photon 2 number:  "   << counter_cut0_photon_2 << endl;
  	cout << "Cut 0 Photon 3 number:  "   << counter_cut0_photon_3 << endl;
  	cout << "Cut 0 Photon 4 number:  "	 << counter_cut0_photon_4 << endl;
  	cout << "Cut 0 Muon number:  "       << counter_cut0_muon 	  << endl;
  	cout << "Cut 0 Electron number:  "   << counter_cut0_electron << endl;
  	cout << "Cut 0 Lepton number:  " 	   << counter_cut0_lepton   << endl;
